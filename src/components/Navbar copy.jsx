...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full backdrop-blur-lg shadow-lg rounded-b-xl z-50">
          ...
          <div className="hidden md:flex md:flex-row md:gap-6 text-3xl">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className="transition duration-200 hover:text-slate-300 hover:cursor-pointer">
                  <MdEmail />
                </button>
              </PopoverTrigger>
